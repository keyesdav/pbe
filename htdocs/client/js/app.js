(function() {
    ...
    app.controller("TestController", function($scope, $state, PbeService){
      ...
      $scope.editTest = function(testId){
        ...
        if(typeof testId === 'undefined' || testId == ""){
          $state.go('test-edit', {"testId": testId});
          // $state.go('test-edit');
        } else {
    ...
    app.controller("TestEditController", function($scope, $state, $q, $stateParams, $cacheFactory, $timeout, PbeService){
